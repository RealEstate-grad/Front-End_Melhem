...
<script>
import SideBar from "@/components/DashBoards/AgentDashboard/SideBar.vue";
  ...
  methods: {
    ...
    codeSearch() {
      for (let [key, value] of Object.entries(this.phonecodes)) {
        console.log(this.data[0].countre_code_phone);
    ...
    getData() {
      axios
        .get(store.state.server + "api/get_user_with_ageant", {
